...
Cliente = { "Nombre": 'Mario Pedernera',      	# Declaración multilinea
               	"DNI": 56895632,
               	"Domicilio":'Los alamos 4509',
                "Compras": ["cafetera", "TV 50 pulgadas", "mouse gamer"],    	# Coma al final válida
               	}
...
# COMPLETAR - INICIO
a,b,c,d,e,f = diccionario_2.get("clave4") 
clave5= e and diccionario_2["clave5"]
#print(clave5)
# COMPLETAR - FIN
...
# COMPLETAR - INICIO
diccionario_6.update(list(diccionario_7.items()))
#print(list(diccionario_6.values()))
# COMPLETAR - FIN
