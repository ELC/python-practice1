...
# COMPLETAR - INICIO
strings_concatenados = "{variable_01}, {variable_02}, {variable_03}, {variable_04}, {variable_05}".format(
    variable_01="Le debo ", variable_02=6, variable_03=" pesos a un amigo hace ", variable_04=" años.", variable_05="Ezequiel")
# COMPLETAR - FIN
